  ...
  return (
    <section className="flex md:bg-gray-100 min-h-screen overflow-hidden">
      ...
      <div className="flex-grow text-gray-800">
        ...
        <IoSearchOutline 
          className="absolute inline-block left-3 top-1/2 transform -translate-y-1/2 cursor-pointer" 
        ...
        <input
          ...
          className="bg-[#EAEAEA] w-full py-1 md:px-8 px-6 rounded-md focus:outline-none pl-10"
        />
      </div>
