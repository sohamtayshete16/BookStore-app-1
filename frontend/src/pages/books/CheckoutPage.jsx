                                    ...
                                    <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                        ...
                                        <div className="md:col-span-5">
                                            ...
                                            <input
                                                ...
                                                type="number" name="phone" id="phone" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="+91 9876543210" />
                                        </div>
                                        ...
                                        <div className="md:col-span-1">
                                            ...
                                            <input
                                                ...
                                                type="text" name="zipcode" id="zipcode" className="transition-all flex items-center h-10 border mt-1 rounded px-4 w-full bg-gray-50" />
                                        </div>
